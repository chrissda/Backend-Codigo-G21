...
from controllers.serializers import ValidarTokenSerializer
...
# origins > los dominios que puede acceder a mi backend
# methods > metodos HTTP que puede consultar a mi backend
...
def validarToken():
    ...
    try:
        ...
        return {
            'message': 'Error al validar el token. Token incorrecto.',
            'args': error.args
        }
...
def resetPassword():
    ...
    try:
        ...
        # Actualizamos el resgistro del usuario encontrado con su nueva password
