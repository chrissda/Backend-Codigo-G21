...
// Configurar lo que podemos aceptar o recibir por el body
// express.json() > indicamos que el contenido que podemos recibir por el body puede ser en formato application/json
servidor.use(express.json());
// Sera otro formato para recibir informacion por el body en formando x-www-url-encoded
// DEPRECADO: ya no se recomiendo utilizar
