...
class CategoriaModel(conexion.Model):
    ...
    # nombre que sea text y no sea null
    nombre = Column(type_=types.Text, nullable=False)
    # fechaCreacion que en la bd se llame fecha_creacion, que sea de tipo TIEMSTAMP
    fechaCreacion = Column(name='fecha_creacion',
                           type_=types.TIMESTAMP, default=datetime.now)
    # disponibilidad que sea True o False y que su valor por defecto sea True
