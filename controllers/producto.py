...
class ProductosController(Resource):
    def post(self):
        ...
        try:
            ...
            # TODO: Antes de guardar el producto validar que exista la categoria, si es que no se le pasa, porque tmb puede haber productos sin categoria
            ...
            return {
                'message': 'Error al crea el producto',
                'content': error.args
