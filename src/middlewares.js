...
export const validarUsuario = async (req, res, next) => {
  // Si la informacion luego de validarla cumple con todo, entonce dejaremos pasar al siguente controlador con la funcion next

  // La informacion de la cabecera de la peticion
  ...
  // En el header de authorization debe de enviar la token en el siguiente formato Bearer xxx.yyyy.zzz
