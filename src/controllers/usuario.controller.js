import { actualizarUsuarioSerializer, loginSerializer, registrarUsuarioSerializer } from "./serializers/usuario.serializer.js";
...
export const registrarUsuario = async (req, res) => {
  ...
  // Valida si la informacion es correcta(valida) o no
...
export const login = async (req, res) => {
  ...
  if (esLaPassword) {
    const token = JWT.sign(
      ...
      {
        // Si el valor es un entero sera segundos o "2days" | "12h" | "4d"
        expiresIn: 60 * 60 * 4,
      }
    );
...
export const actualizarUsuario = async (req, res) => {
  // req.user > tiene toda la informacion del usaurio registrado
