...
export const listarEquipos = async (req, res) => {
  ...
  const filtros = {};
  if (req.query.nombre) {
    // Si queremos hacer la busqueda mendiante una similitud del resultado
  ...
  // Crear el controlador para lista todos los equipos
  // Cualquier usuario (identificado o no) puede acceder a la esta informacion
